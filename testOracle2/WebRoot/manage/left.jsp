...
<dl class="leftmenu">
  <dd>
    ...
    <ul class="menuson">
      <li><cite></cite><a href="../AllJobServlet?action=page&currentpageIndex=1" target="rightFrame">职位申请查看</a><i></i></li>
      <li><cite></cite><a href="jobList.html" target="rightFrame">职位管理</a><i></i></li>
      <li><cite></cite><a href="../CompanyServlet?currentpageindex=1" target="rightFrame">企业管理</a><i></i></li>
    </ul>
  </dd>
  <dd>
